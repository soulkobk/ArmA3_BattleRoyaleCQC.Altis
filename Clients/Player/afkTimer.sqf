...
_afkTimeMax = 5*60; // maximum 5 minutes AFK time (default).
...
while {afkTimerCheck} do
{
	...
	// added in force NOT AFK for built in spectating via debug console menu. 2017-04
	if (["IsSpectating", [player]] call BIS_fnc_EGSpectator) then // bool
	{
		_timerAFK = nil;
	};

...
waitUntil {OSM_OK};
///////////////////////////////////////////////////////////////////////////////////////////////////
// GATHER PLAYERS FOR ROUND ZONE IF CRITERIA MATCHES
_players = [];
_numPlayers = 0;
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// PRE CALCULATE SAFE SPAWN POSITIONS
_positions = [];
_positionCount = 0;
while {!(_positionCount isEqualTo _numPlayers)} do
{
	_positions = [
		["position", (getMarkerPos BRMini_CurrZone)],
		["number", _numPlayers],
		["range", [100, (BRMini_ZoneSize - 100)]],
		["sector", [0, 360]],
		["posDistance", 100],
		["maxGradient", 1]
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// TELEPORT PLAYERS TO ROUND ZONE IF CRITERIA MATCHES
_players = _players call BIS_fnc_arrayShuffle; // shuffle the player array... mo' random placement yo!
{
	if ((alive _x) && (isPlayer _x) && (_x getVariable "isPlaying")) then
	{

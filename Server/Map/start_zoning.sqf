/*
	...
	I wrote this shitty code back in 2015 when I was in my first month of learning ArmA 3 coding. It's somewhat clunky, but it works.
	Some small updates have been done in 2016... and will suffice for an addition to the existing BR code.
*/

_lootMinutes = 4; // 2 default
// _roundMinutes = 24;
_roundMinutes = 16;

// total minutes of round will be _lootMinutes + _roundMinutes, eg 24 + 4 = 28 minutes for a FULL round
...
///////////////////////////////////////////////////////////////////////////////////////////////////
_blueMarker = createMarker ["blueZone",_zoneCenter];
...
///////////////////////////////////////////////////////////////////////////////////////////////////
diag_log format ["<BRMINI>: %1 LOOTING STARTED, %2 MINUTES UNTIL ZONING BEGINS!",BRMini_CurrZoneName,_lootMinutes];
_ticksLootInit = round(diag_tickTime);
while {(_ticksLoot < _ticksLootMax) && BRMini_InGame} do
{
	///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		{
			...
			{
				if !(_x inArea BRMini_BlackZone) then // checks if player is inside the "BRMini_BlackZone" area, if NOT, then do...
				{
		...
		} forEach ((getMarkerPos BRMini_BlackZone) nearObjects ["Man",(BRMini_ZoneSize * 2)]);
		_zoneNextCheckTicks = _ticksLoot + _zoneDamageDuration;
	};
	///////////////////////////////////////////////////////////////////////////////////////////////////	
...
{
	diag_log format ["<BRMINI>: %1 ZONING STARTED, ZONING WILL LAST A MAXIMUM %2 MINUTES!",BRMini_CurrZoneName,_roundMinutes];
}
else
{
	diag_log format ["<BRMINI>: %1 ZONING SKIPPED!",BRMini_CurrZoneName];
};
///////////////////////////////////////////////////////////////////////////////////////////////////
